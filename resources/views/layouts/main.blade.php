...
<head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{ asset('../../assets/images/meditechTab.svg') }}" />
    <style>
    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                <a class="sidebar-brand brand-logo" href="/dashboard"><img src="{{ asset('assets/images/meditech.svg') }}"
                        alt="logo" style="height: 100px;" /></a>
                <a class="sidebar-brand brand-logo-mini" href="/dashboard"><img
                        src="{{ asset('../../assets/images/meditechTab.svg') }}" style="height: 10cm;" alt="logo" /></a>
            </div>
            <ul class="nav">
            ...
            <nav class="navbar p-0 fixed-top d-flex flex-row">
                <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
                    <a class="navbar-brand brand-logo-mini" href="/dashboard"><img
                            src="../../assets/images/meditechTab.svg" alt="logo" /></a>
                </div>
                <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        <li class="nav-item dropdown d-none d-lg-block">
                            <a class="nav-link btn btn-lg create-new-button" style="background-color: #104d45"
                                id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false"
                                href="#">+ Create Data Master</a>
